"""SELECTION EX FOR BRIER EXPERIMENTS WITH PID
nohup python3 2_main_ex_brier_selection_pid.py TEST > 2_TEST_PID.out 2>&1 &
"""
...
DATA = f"{file.parents[2]}/MNHN_RESULT/2_PRE_EXAMPLE_{args.train_test}/EXAMPLES_6_40_50_PID"
PATH_DICT_FRAC_SEED =  f"{file.parents[2]}/MNHN_RESULT/2_PRE_EXAMPLE_{args.train_test}/frac_ex.csv"
DATA_RESULT_GLOBAL = f"{file.parents[2]}/MNHN_RESULT/4_EXAMPLE_{args.train_test}_1M_PID"
DATA_RESULT = f"{DATA_RESULT_GLOBAL}/{L}_{PID_INF}_{PID_SUP}_PID"
...
FILE_EXAMPLES = f"{DATA_RESULT}/EX_BRIER_{args.train_test}_1M_PID.csv"
