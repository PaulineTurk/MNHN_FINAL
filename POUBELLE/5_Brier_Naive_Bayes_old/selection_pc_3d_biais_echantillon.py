...
bash bash_selection_pc_3d_biais_echantillon.sh
"""
...
DATA_RESULT = f"{file.parents[2]}/MNHN_RESULT/5_PC_3D_SELECTION_CORRECTION_BIAIS_test_3"
...
for context in list_context:
    ...
    for nb_exemple_test in list_nb_example:
        ...
        if context_ol != 0 or context == (0,0,0,0):  # CHOIX DISCUTABLE ................................................................
        ...
        if context_or != 0:
            list_example = selection_example.multi_random_example_selection(path_folder_seed, dico_example,
                                                                        path_folder_dico_seq,
                                                                        0, MAX_RELATIVE_POSITION, 0, 0,
                                                                        ALPHABET)
    
        if context_dl != 0:
            list_example = selection_example.multi_random_example_selection(path_folder_seed, dico_example,
                                                                        path_folder_dico_seq,
                                                                        0, 0, MAX_RELATIVE_POSITION, 0,
                                                                        ALPHABET)
        if context_dr != 0:
            list_example = selection_example.multi_random_example_selection(path_folder_seed, dico_example,
                                                                        path_folder_dico_seq,
                                                                        0, 0, 0, MAX_RELATIVE_POSITION,
                                                                        ALPHABET)

                                                            


        list_unit_score_brier, list_unit_score_brier_non_contextuel = brier.brier_score_correction_biais(list_example,
